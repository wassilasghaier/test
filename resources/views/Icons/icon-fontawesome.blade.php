          ...
          <div class="col-sm-12">
             ...
             <div class="iq-card-body">
                ...
                <div class="row mt-3">
                      ...
                      <div class="col-sm-6 col-md-4 col-lg-2">
                         <a class="iq-icons-list" href="#"><i class="fa fa-telegram" aria-hidden="true"></i>telegram</a>
                      </div>
                      <div class="col-sm-6 col-md-4 col-lg-2">
                         <a class="iq-icons-list" href="#"><i class="fa fa-user-circle" aria-hidden="true"></i>user-circle</a>
                      </div>
                      <div class="col-sm-6 col-md-4 col-lg-2">
                         <a class="iq-icons-list" href="#"><i class="fa fa-area-chart" aria-hidden="true"></i>area-chart</a>
                      </div>
                      <div class="col-sm-6 col-md-4 col-lg-2">
                      ...
                      <div class="col-sm-6 col-md-4 col-lg-2">
                         <a class="iq-icons-list" href="#"><i class="fa fa-bluetooth" aria-hidden="true"></i>bluetooth</a>
                      </div>
                      <div class="col-sm-6 col-md-4 col-lg-2">
                      ...
                      <div class="col-sm-6 col-md-4 col-lg-2">
                         <a class="iq-icons-list" href="#"><i class="fa fa-commenting" aria-hidden="true"></i>commenting</a>
                      </div>
                      <div class="col-sm-6 col-md-4 col-lg-2">
                      ...
                      <div class="col-sm-6 col-md-4 col-lg-2">
                         <a class="iq-icons-list" href="#"><i class="fa fa-snapchat" aria-hidden="true"></i>snapchat</a>
                      </div>
                      <div class="col-sm-6 col-md-4 col-lg-2">
                         <a class="iq-icons-list" href="#"><i class="fa fa-twitter" aria-hidden="true"></i>twitter</a>
                      </div>
                      <div class="col-sm-6 col-md-4 col-lg-2">
                         <a class="iq-icons-list" href="#"><i class="fa fa-wordpress" aria-hidden="true"></i>wordpress</a>
                      </div>
                      <div class="col-sm-6 col-md-4 col-lg-2">
                         <a class="iq-icons-list" href="#"><i class="fa fa-wordpress" aria-hidden="true"></i>wordpress</a>
                      </div>
