             ...
             <div class="iq-card">
                ...
                <div class="iq-card-body">
                   ...
                   <div class="custom-control custom-switch custom-control-inline">                              
                      {!! Form::checkbox('check',null ,false, array('class'=>"custom-control-input")) !!}   
                      {!! Form::label('false', 'false / Inactive', array('class'=>'custom-control-label')) !!}
                   </div>
                   <div class="custom-control custom-switch custom-control-inline">
                    {!! Form::checkbox('check',null, array('class'=>"custom-control-input")) !!}   
                    {!! Form::label('false', 'true / active', array('class'=>'custom-control-label')) !!}
                   ...
                   <div class="custom-control custom-switch custom-control-inline">
                    {!! Form::checkbox('check',null, false, array('class'=>"custom-control-input")) !!}   
                    {!! Form::label('false', 'disable / Inactive', array('class'=>'custom-control-label')) !!}
