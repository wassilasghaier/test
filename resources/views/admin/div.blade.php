                  ...
                  <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">Liste des opérations de multiplication</h4>
                           </div>
                        </div>
                    ...
                    <td  class= "text-center"contenteditable="false"><img class="rounded-circle img-fluid avatar-40" src="{{$operation->user->image}}" alt="profile"> </td>
						 ...
						 <a data-toggle="tooltip" data-placement="top" title="" data-original-title="show" href="{{url('/admin/operations/division/'.$operation->user_id)}}"><i class="ri-slideshow-4-line"></i></a>          
                         </div> 
						 </td>
				         </tr>
                          @endforeach
