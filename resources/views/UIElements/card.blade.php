...
<div id="content-page" class="content-page">
    <div class="container-fluid">
       <div class="row">
          <div class="col-sm-3">
             <div class="card iq-mb-3">
                <img src={{asset("assets/images/page-img/07.jpg")}} class="card-img-top" alt="#">
                <div class="card-body">
       ...
       <div class="row">
          ...
          <div class="col-sm-4">
             <div class="card bg-dark text-white iq-mb-3">
                <img src={{asset("assets/images/page-img/07.jpg")}} class="card-img" alt="#">
          ...
          <div class="col-lg-6">
             <div class="card iq-mb-3">
                <div class="row no-gutters">
                   <div class="col-md-4">
                      <img src={{asset("assets/images/page-img/08.jpg")}} class="card-img" alt="#">
                   </div>
                   <div class="col-md-8">
                      <div class="card-body">
                         <h4 class="card-title">Card title</h4>
          ...
          <div class="col-lg-6">
             <div class="card iq-mb-3">
                <div class="row no-gutters flex-row-reverse">
                   <div class="col-md-4">
                      <img src={{asset("assets/images/page-img/09.jpg")}} class="card-img" alt="#">
                   </div>
                   <div class="col-md-8">
       ...
       <div class="row">
          ...
          <div class="col-lg-4">
             <div class="card iq-mb-3 text-white bg-success" >
                <div class="card-body">
          ...
          <div class="col-lg-4">
             <div class="card iq-mb-3 text-white bg-warning" >
                <div class="card-body">
       ...
       <div class="row">
          ...
          <div class="col-lg-4">
             <div class="card iq-mb-3 border-secondary" >
          ...
          <div class="col-lg-4">
             <div class="card iq-mb-3 border-danger" >
          ...
          <div class="col-lg-4">
             <div class="card iq-mb-3 border-warning" >
          ...
          <div class="col-lg-4">
             <div class="card iq-mb-3 border-info" >
       ...
       <div class="row">
          ...
          <div class="col-sm-12">
             ...
             <div class="card-columns">
                ...
                <div class="card bg-primary text-white text-center iq-mb-3">
                   <blockquote class="blockquote mb-0 card-body">
                      <p class="font-size-14">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
                      <footer class="blockquote-footer">
                ...
                <div class="card text-center iq-mb-3">
                   <div class="card-body">
                      <h4 class="card-title">Card title</h4>
                ...
                <div class="card text-right iq-mb-3">
