          ...
          <div class="col-sm-12 col-lg-6">
             <div class="iq-card">
                ...
                <div class="iq-card-body">
                   ...
                   <img src={{asset("assets/images/small/img-1.jpg")}} class="img-fluid" alt="Responsive image">
                </div>
             </div>
             <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
          ...
          <div class="col-sm-12 col-lg-6">
             <div class="iq-card">
                ...
                <div class="iq-card-body">
                   ...
                   <img src={{asset("assets/images/page-img/10.jpg")}} class="img-thumbnail" alt="Responsive image">
                   <img src={{asset("assets/images/page-img/11.jpg")}} class="rounded ml-3" alt="Responsive image">
                   <img src={{asset("assets/images/page-img/12.jpg")}} class="rounded-circle ml-3" alt="Responsive image">
                </div>
             </div>
          <div class="iq-card">
             <div class="iq-card-header d-flex justify-content-between">
             ...
             <div class="iq-card-body">
                <p>In addition to our <a href="/docs/4.3/utilities/borders/">border-radius utilities</a>, you can use <code>.img-thumbnail</code> to give an image a rounded 1px border appearance.</p>
                <img src={{asset("assets/images/page-img/13.jpg")}} class="" alt="Responsive image">
                <img src={{asset("assets/images/page-img/14.jpg")}} class="float-right" alt="Responsive image">
             </div>
          </div>
          <div class="iq-card">
             <div class="iq-card-header d-flex justify-content-between">
             ...
             <div class="iq-card-body">
                ...
                <div class="media mb-4">
                   <img src={{asset("assets/images/page-img/22.jpg")}} class="align-self-center mr-3" alt="#">
                   <div class="media-body">
                ...
                <div class="media">
                   <img src={{asset("assets/images/page-img/23.jpg")}} class="align-self-end mr-3" alt="#">
                   <div class="media-body">
