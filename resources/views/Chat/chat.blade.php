                         ...
                         <div class="chat-search pt-3 pl-3">
                            <div class="d-flex align-items-center">
                               <div class="chat-profile mr-3">
                                  <img src={{asset("assets/images/user/1.jpg")}} alt="chat-user" class="avatar-60 ">
                               </div>
                            ...
                            <div id="user-detail-popup" class="scroller">
                               <div class="user-profile">
                                  ...
                                  <div class="user text-center mb-4">
                                   <a class="avatar m-0">
                                     <img src={{asset("assets/images/user/1.jpg")}} alt="avatar">
                                   </a>
                         ...
                         <div class="chat-sidebar-channel scroller mt-4 pl-3">
                            ...
                            <ul class="iq-chat-ui nav flex-column nav-pills">
                               ...
                               <li>
                                  ...
                                  <div class="d-flex align-items-center">
                                     <div class="avatar mr-3">
                                        <img src={{asset("assets/images/user/06.jpg")}} alt="chatuserimage" class="avatar-50 ">
                                        <span class="avatar-status"><i class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                     </div>
                                     <div class="chat-sidebar-name">
                            ...
                            <!-- <ul class="iq-chat-ui nav flex-column nav-pills"> -->
                              <li>
                                  ...
                                  <div class="d-flex align-items-center">
                                     <div class="avatar mr-3">
                                        <img src={{asset("assets/images/user/07.jpg")}} alt="chatuserimage" class="avatar-50 ">
                               ...
                               <li>
                                  ...
                                  <div class="d-flex align-items-center">
                                     <div class="avatar mr-3">
                                        <img src={{asset("assets/images/user/08.jpg")}} alt="chatuserimage" class="avatar-50 ">
                                        <span class="avatar-status"><i class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                     </div>
                                     <div class="chat-sidebar-name">
                               ...
                               <li>
                                  ...
                                  <div class="d-flex align-items-center">
                                     <div class="avatar mr-3">
                                        <img src={{asset("assets/images/user/09.jpg")}} alt="chatuserimage" class="avatar-50 ">
                            ...
                            <!-- <ul class="iq-chat-ui nav flex-column nav-pills"> -->
                               <li>
                                  ...
                                  <div class="d-flex align-items-center">
                                     <div class="avatar mr-3">
                                        <img src={{asset("assets/images/user/10.jpg")}} alt="chatuserimage" class="avatar-50 ">
                            ...
                            <div class="tab-pane fade" id="chatbox1" role="tabpanel">
                                  ...
                                  <header class="d-flex justify-content-between align-items-center bg-white pt-3 pr-3 pb-3">
                                    ...
                                    <div id="chat-user-detail-popup" class="scroller" class="scroller">
                                        <div class="user-profile text-center">
                                           ...
                                           <div class="user mb-4">
                                            <a class="avatar m-0">
                                              <img src={{asset("assets/images/user/05.jpg")}} alt="avatar">
                                            </a>
                                          <div class="user-name mt-4"><h4>Nik Jordan</h4></div>
                               ...
                               <div class="chat-content scroller">
                                  ...
                                  <div class="chat chat-left">
                                    <div class="chat-user">
                                      <a class="avatar m-0">
                                        <img src={{asset("assets/images/user/05.jpg")}} alt="avatar" class="avatar-35 ">
                                      </a>
                            ...
                            <div class="tab-pane fade" id="chatbox2" role="tabpanel">
                                  ...
                                  <header class="d-flex justify-content-between align-items-center bg-white pt-3  pl-3 pr-3 pb-3">
                                    <div class="d-flex align-items-center">
                                     <div id="sidebar-toggle" class="sidebar-toggle">
                                      ...
                                      <div class="avatar chat-user-profile m-0 mr-3">
                                        <img src={{asset("assets/images/user/06.jpg")}} alt="avatar" class="avatar-50 ">
                                        <span class="avatar-status"><i class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                      </div>
                                    ...
                                    <div id="chat-user-detail-popup" class="scroller" class="scroller">
                                        <div class="user-profile text-center">
                                           ...
                                           <div class="user mb-4">
                                            <a class="avatar m-0">
                                              <img src={{asset("assets/images/user/06.jpg")}} alt="avatar">
                                            </a>
                               ...
                               <div class="chat-content scroller">
                                  ...
                                  <div class="chat chat-left">
                                    <div class="chat-user">
                                      <a class="avatar m-0">
                                        <img src={{asset("assets/images/user/06.jpg")}} alt="avatar" class="avatar-35 ">
                                      </a>
                                        <span class="chat-time mt-1">6:48</span>
                                    </div>
                                    <div class="chat-detail">
                            ...
                            <div class="tab-pane fade" id="chatbox3" role="tabpanel">
                                  ...
                                  <header class="d-flex justify-content-between align-items-center bg-white pt-3 pl-3 pr-3 pb-3">
                                    <div class="d-flex align-items-center">
                                     <div id="sidebar-toggle" class="sidebar-toggle">
                                      ...
                                      <div class="avatar chat-user-profile m-0 mr-3">
                                        <img src={{asset("assets/images/user/07.jpg")}} alt="avatar" class="avatar-50 ">
                                        <span class="avatar-status"><i class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                      </div>
                                    ...
                                    <div id="chat-user-detail-popup" class="scroller" class="scroller">
                                        <div class="user-profile text-center">
                                           ...
                                           <div class="user mb-4">
                                            <a class="avatar m-0">
                                              <img src={{asset("assets/images/user/07.jpg")}} alt="avatar">
                                            </a>
                               ...
                               <div class="chat-content scroller">
                                  ...
                                  <div class="chat chat-left">
                                    <div class="chat-user">
                                      <a class="avatar m-0">
                                        <img src={{asset("assets/images/user/07.jpg")}} alt="avatar" class="avatar-35 ">
                                      </a>
                                        <span class="chat-time mt-1">6:48</span>
                                    </div>
                                    <div class="chat-detail">
                            ...
                            <div class="tab-pane fade" id="chatbox4" role="tabpanel">
                                  ...
                                  <header class="d-flex justify-content-between align-items-center bg-white pt-3 pl-3 pr-3 pb-3">
                                    <div class="d-flex align-items-center">
                                     <div id="sidebar-toggle" class="sidebar-toggle">
                                      ...
                                      <div class="avatar chat-user-profile m-0 mr-3">
                                        <img src={{asset("assets/images/user/08.jpg")}} alt="avatar" class="avatar-50 ">
                                        <span class="avatar-status"><i class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                      </div>
                                    ...
                                    <div id="chat-user-detail-popup" class="scroller" class="scroller">
                                        <div class="user-profile text-center">
                                           ...
                                           <div class="user mb-4">
                                            <a class="avatar m-0">
                                              <img src={{asset("assets/images/user/08.jpg")}} alt="avatar">
                                            </a>
                               ...
                               <div class="chat-content scroller">
                                  ...
                                  <div class="chat chat-left">
                                    <div class="chat-user">
                                      <a class="avatar m-0">
                                        <img src={{asset("assets/images/user/08.jpg")}} alt="avatar" class="avatar-35 ">
                                      </a>
                                        <span class="chat-time mt-1">6:48</span>
                                    </div>
                                    <div class="chat-detail">
                            ...
                            <div class="tab-pane fade" id="chatbox5" role="tabpanel">
                                  ...
                                  <header class="d-flex justify-content-between align-items-center bg-white pt-3 pl-3 pr-3 pb-3">
                                    <div class="d-flex align-items-center">
                                     <div id="sidebar-toggle" class="sidebar-toggle">
                                      ...
                                      <div class="avatar chat-user-profile m-0 mr-3">
                                        <img src={{asset("assets/images/user/09.jpg")}} alt="avatar" class="avatar-50 ">
                                        <span class="avatar-status"><i class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                      </div>
                                    ...
                                    <div id="chat-user-detail-popup" class="scroller" class="scroller">
                                        <div class="user-profile text-center">
                                           ...
                                           <div class="user mb-4">
                                            <a class="avatar m-0">
                                              <img src={{asset("assets/images/user/09.jpg")}} alt="avatar">
                                            </a>
                               ...
                               <div class="chat-content scroller">
                                  ...
                                  <div class="chat chat-left">
                                    <div class="chat-user">
                                      <a class="avatar m-0">
                                        <img src={{asset("assets/images/user/09.jpg")}} alt="avatar" class="avatar-35 ">
                                      </a>
                                        <span class="chat-time mt-1">6:48</span>
                                    </div>
                                    <div class="chat-detail">
                            ...
                            <div class="tab-pane fade" id="chatbox6" role="tabpanel">
                                  ...
                                  <header class="d-flex justify-content-between align-items-center bg-white pt-3 pl-3 pr-3 pb-3">
                                    <div class="d-flex align-items-center">
                                     <div id="sidebar-toggle" class="sidebar-toggle">
                                      ...
                                      <div class="avatar chat-user-profile m-0 mr-3">
                                        <img src={{asset("assets/images/user/10.jpg")}} alt="avatar" class="avatar-50 ">
                                        <span class="avatar-status"><i class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                      </div>
                                    ...
                                    <div id="chat-user-detail-popup" class="scroller" class="scroller">
                                        <div class="user-profile text-center">
                                           ...
                                           <div class="user mb-4">
                                            <a class="avatar m-0">
                                              <img src={{asset("assets/images/user/10.jpg")}} alt="avatar">
                                            </a>
                               ...
                               <div class="chat-content scroller">
                                  ...
                                  <div class="chat chat-left">
                                    <div class="chat-user">
                                      <a class="avatar m-0">
                                        <img src={{asset("assets/images/user/10.jpg")}} alt="avatar" class="avatar-35 ">
                                      </a>
                                        <span class="chat-time mt-1">6:48</span>
                                    </div>
                                    <div class="chat-detail">
